...
public class TeamTypesController extends BaseController {
    ...
    public R addInfo(TeamTypes teamTypes) {
        ...
        Log.info("添加球队职位，传入参数：{}", teamTypes);
    ...
    public R updInfo(TeamTypes teamTypes) {
        ...
        Log.info("修改球队职位，传入参数：{}", teamTypes);
